...
struct flagspec{
    ...
    gonsize_t strpool_pool_size;
    gonsize_t strpool_pool_last;
    flagc_t size;
    flagc_t last;
...
int flagspec_set_longname(struct flagspec *spec, char *longname, gonsize_t len);
int flagspec_set_identifier(struct flagspec *spec, char *identifier, gonsize_t len);
